## rtabmap (jazzy) - 0.21.10-1

The packages in the `rtabmap` repository were released into the `jazzy` distro by running `/root/venv/bin/bloom-release -r jazzy rtabmap --override-release-repository-push-url git@github.com:revyos-ros/rtabmap-release.git` on `Thu, 06 Mar 2025 05:46:00 -0000`
...
## rtabmap (humble) - 0.21.10-1

The packages in the `rtabmap` repository were released into the `humble` distro by running `/home/z572/gits/revyos-ros/venv2/bin/bloom-release -r humble rtabmap --override-release-repository-push-url git@github.com:revyos-ros/rtabmap-release.git` on `Mon, 17 Feb 2025 01:20:42 -0000`
...
## rtabmap (humble) - 0.21.6-1

The packages in the `rtabmap` repository were released into the `humble` distro by running `/usr/bin/bloom-release --ros-distro humble rtabmap` on `Tue, 23 Jul 2024 04:25:50 -0000`
...
## rtabmap (iron) - 0.21.6-1

The packages in the `rtabmap` repository were released into the `iron` distro by running `/usr/bin/bloom-release --ros-distro iron rtabmap` on `Tue, 23 Jul 2024 04:23:10 -0000`
...
## rtabmap (jazzy) - 0.21.6-1

The packages in the `rtabmap` repository were released into the `jazzy` distro by running `/usr/bin/bloom-release --ros-distro jazzy rtabmap` on `Tue, 23 Jul 2024 04:20:53 -0000`
...
## rtabmap (rolling) - 0.21.6-1

The packages in the `rtabmap` repository were released into the `rolling` distro by running `/usr/bin/bloom-release --ros-distro rolling rtabmap` on `Tue, 23 Jul 2024 04:18:34 -0000`
...
## rtabmap (iron) - 0.21.5-1

The packages in the `rtabmap` repository were released into the `iron` distro by running `/usr/bin/bloom-release --ros-distro iron rtabmap` on `Mon, 01 Jul 2024 03:14:31 -0000`
...
## rtabmap (jazzy) - 0.21.5-2

The packages in the `rtabmap` repository were released into the `jazzy` distro by running `/usr/bin/bloom-release --ros-distro jazzy rtabmap` on `Mon, 01 Jul 2024 03:00:34 -0000`
...
- upstream repository: https://github.com/introlab/rtabmap.git
- release repository: https://github.com/ros2-gbp/rtabmap-release.git
- rosdistro version: `0.21.1-3`
- old version: `0.21.1-3`
- new version: `0.21.5-1`
...
## rtabmap (jazzy) - 0.21.5-1

The packages in the `rtabmap` repository were released into the `jazzy` distro by running `/usr/bin/bloom-release rtabmap --rosdistro jazzy --track jazzy --new-track` on `Mon, 27 May 2024 17:55:56 -0000`
...
- upstream repository: https://github.com/introlab/rtabmap.git
- release repository: https://github.com/ros2-gbp/rtabmap-release.git
- rosdistro version: `0.21.1-4`
- old version: `0.21.1-4`
- new version: `0.21.5-1`
...
## rtabmap (iron) - 0.21.4-1

The packages in the `rtabmap` repository were released into the `iron` distro by running `/usr/bin/bloom-release --ros-distro iron rtabmap` on `Wed, 21 Feb 2024 03:16:44 -0000`
...
## rtabmap (humble) - 0.21.4-1

The packages in the `rtabmap` repository were released into the `humble` distro by running `/usr/bin/bloom-release --ros-distro humble rtabmap` on `Wed, 21 Feb 2024 03:14:33 -0000`
...
## rtabmap (humble) - 0.21.3-1

The packages in the `rtabmap` repository were released into the `humble` distro by running `/usr/bin/bloom-release rtabmap --rosdistro humble` on `Thu, 04 Jan 2024 16:58:41 -0000`
...
## rtabmap (iron) - 0.21.3-1

The packages in the `rtabmap` repository were released into the `iron` distro by running `/usr/bin/bloom-release rtabmap --rosdistro iron` on `Thu, 04 Jan 2024 16:51:42 -0000`
...
## rtabmap (iron) - 0.21.2-1

The packages in the `rtabmap` repository were released into the `iron` distro by running `/usr/bin/bloom-release rtabmap --track iron --rosdistro iron --new-track` on `Sat, 05 Aug 2023 22:17:19 -0000`
...
## rtabmap (humble) - 0.21.1-1

The packages in the `rtabmap` repository were released into the `humble` distro by running `/usr/bin/bloom-release rtabmap --rosdistro humble` on `Sun, 09 Apr 2023 22:19:12 -0000`
...
## rtabmap (rolling) - 0.21.1-2

The packages in the `rtabmap` repository were released into the `rolling` distro by running `/usr/bin/bloom-release --rosdistro rolling --track rolling rtabmap` on `Sun, 09 Apr 2023 21:43:48 -0000`
...
- upstream repository: https://github.com/introlab/rtabmap.git
- release repository: https://github.com/ros2-gbp/rtabmap-release.git
- rosdistro version: `0.20.23-2`
- old version: `0.21.1-1`
- new version: `0.21.1-2`
...
## rtabmap (rolling) - 0.21.1-1

The packages in the `rtabmap` repository were released into the `rolling` distro by running `/usr/bin/bloom-release --rosdistro rolling --track rolling rtabmap` on `Sun, 09 Apr 2023 20:14:55 -0000`
